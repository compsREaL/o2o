...
public class ProductDetailController {
    ...
    // 微信获取用户信息的api前缀
    private static String urlPrefix = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx98b992a914efa61f&redirect_uri=";
    // 微信获取用户信息的api中间部分
    ...
    private static String productMapUrl = "http://127.0.0.1:8080/o2o/shopadmin/adduserproductmap";
